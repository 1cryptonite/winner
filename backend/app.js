...
const ludoOdds = require('./utils/ludoOdds');
...
const virtualGameApiController = routes.virtualGameApiController;
const casinoGamesReportController = routes.casinoGamesReportController;
const paymentApiController = routes.paymentApiController;
...
app.use(settings.API_URL, virtualGameApiController);
app.use(settings.API_URL, casinoGamesReportController);
app.use(settings.API_URL, paymentApiController);
...
app.listen(settings.PORT2, function () {
	successlog.info('Running at PORT  ' + settings.PORT2);
}); */

app.listen(settings.PORT3, function () {
	successlog.info('Running at PORT  ' + settings.PORT3);
});
