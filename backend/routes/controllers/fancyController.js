...
async function createFancy(req, res) {
	try {
		...
		logger.errorlog.error("createFancy",e);
		return apiSuccessRes(req, res, 'Error to create Fancy.');
	}
}
async function getFancy(req, res) {
	try {
		...
		logger.errorlog.error("getFancy",e);
...
async function getIndianFancy(req, res) {
	try {
		...
		logger.errorlog.error("getIndianFancy",e);
...
async function getFancyById(req, res) {
	try {
		...
		logger.errorlog.error("getFancyById",e);
	}
}
...
async function updateFancyById(req, res) {
	try {
		...
		logger.errorlog.error("updateFancyById",e);
	}
}
...
async function getRunTimeFancyPosition(req, res) {
    try {
        ...
        let fancyList = await fancyService.getRunTimeFancyPosition(user_id,fancy_id,user_type_id,[0],is_show_100_percent);
