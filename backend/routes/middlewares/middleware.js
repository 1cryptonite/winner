...
var middleware = async function (req, res, next) {
	...
	if(constants.SITE_UNDER_MAINTENANCE=="1" && req.body.userid!=1){
	...
	const ignored_routes = [
		...
		'/api/v1/signUp',
    '/api/v1/brino/verifyToken',
		'/api/v1/brinoFantasy/fantasyVerifyToken',
		'/api/v1/brinoFantasy/fantasyJoinContest',
		'/api/v1/brinoFantasy/fantasyResult',
		'/api/v1/brinoFantasy/fantasyGetBalance',
		'/api/v1/brinoFantasy/fantasyRollbackContest',
		'/api/v1/paymentApi/paymentCallback',
		'/api/v1/updatescorekey'
	];
